...
class DaikinBRC52bClimate : public climate_ir::ClimateIR {
 public:
  ...
  void enable_power_on_timer(uint32_t power_on_time);
  void disable_power_on_timer();
  void enable_power_off_timer(uint32_t power_off_time);
  void disable_power_off_timer();
 ...
 protected:
  ...
  optional<uint8_t> power_on_timer_state_{};
  optional<uint8_t> power_off_timer_state_{};
